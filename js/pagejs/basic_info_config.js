$(function () {
  ...
  function addProject ($addBtn, $modal) {
    var $cancelBtn = $modal.find('input[type=reset]'),
      $saveBtn = $modal.find('input[type=submit]')
  ...
  function deleteProject ($tab) {
    var $deleteBtn = $tab.find('.delete'),
      ...
      $cancelBtn = $sucModal.find('input[type=reset]'),
      $saveBtn = $sucModal.find('input[type=submit]')
